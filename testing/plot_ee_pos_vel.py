...
# Load the CSV file
file_path_state = "/home/hisham246/uwaterloo/pickplace_cartesian_impedance/csv/episode_0.csv"
file_path_action = "/home/hisham246/uwaterloo/pickplace_cartesian_impedance/policy_actions_episode_0.csv"
...
time_state = state['timestamp'] - state['timestamp'].iloc[0]
time_action = action['timestamp'] - action['timestamp'].iloc[0]
cmd_pos = action[['ee_pos_0', 'ee_pos_1', 'ee_pos_2']].to_numpy()
act_pos = state[['robot0_eef_pos_0', 'robot0_eef_pos_1', 'robot0_eef_pos_2']].to_numpy()
...
for i in range(3):
    ...
    axes[i].plot(time_state, act_pos[:, i], label='Actual')
